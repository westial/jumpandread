...
public abstract class Presenter
{
    ...
    public final static String ALTERNATIVE_VOICE_START_TOKEN = "{{ alternative_voice }}";
    public final static String ALTERNATIVE_VOICE_END_TOKEN = "{{ end alternative_voice }}";
    ...
    private Set<String> TOKENS = new HashSet<>(
            Arrays.asList(
                    ...
                    DOMAIN_START_TOKEN,
                    DOMAIN_END_TOKEN,
                    ALTERNATIVE_VOICE_START_TOKEN,
                    ALTERNATIVE_VOICE_END_TOKEN
            )
    );

    private LinkedList<Object[]> textKits = new LinkedList<>();

    private LinkedList<Object[]> repeatKits = new LinkedList<>();
    ...
    public abstract String alternativeVoice(boolean startToggle);
    ...
    public void addRepeat(String text)
    {
        repeatKits.add(new Object[]{text});
    }
    ...
    public void addRepeat(String format, Object... args)
    {
        Object[] formats = new Object[]{format};
        formats = ArrayUtils.addAll(formats, args);
        repeatKits.add(formats);
    }
    ...
    private String humanize(String content)
    {
        ...
        content = content.replace(Presenter.DOMAIN_START_TOKEN, domain(true));
        content = content.replace(Presenter.DOMAIN_END_TOKEN, domain(false));
        content = content.replace(Presenter.ALTERNATIVE_VOICE_START_TOKEN, alternativeVoice(true));
        content = content.replace(Presenter.ALTERNATIVE_VOICE_END_TOKEN, alternativeVoice(false));
    ...
    private String process(LinkedList<Object[]> texts)
    {
        String result = "";
        for (Object[] formatAndArgs: texts)
        {
    ...
    {
        return process(textKits);
    }

    public String repeat()
    {
        if (repeatKits.isEmpty())
        {
            return output();
        }
        return process(repeatKits);
    }
}
