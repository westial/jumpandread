...
public class MockDynamoDbStateFactory implements StateFactory
{
    ...
    public MockDynamoDbStateFactory(StateRepository repository, State forcedCurrentState)
    {
    ...
    @Override
    public State create(String userId, String sessionId, String intent, String searchId)
    {
